...
description: Build and content architecture of the Ahrensburg mdBook project, including mdBook rendering, Mermaid diagrams, the Co-Wiki editorial pipeline, deploy flow, and conventions.
tags:
  - architecture
  - mdbook
  - build
